...
- 요즘에 주변을 둘러보면 온통 소프트웨어

**장인의 길**

**열정** : 여러가지를 계속해서 끊임없이 공부하고 만들어나가는 열정

진정한 장인은 먼저 코드 작성이 아닌 문제 해결에 집중 - 장인은 자신이 떠나고 부끄러운일로 떠올리는 상황을 만들지 않음

**정직과 용기** : 필요한 상황에서 고객에게 ‘아니오’라고 말할 용기<br>
고객이 나쁜 의사결정을 할때 적절치 못하다고 지적하는 정직함과 용기<br>
모든 아니오에는 항상 대안을 제시해야함

- 커리어의 전진

개발자들 모아놓고 미래에 어떤 일을 하고 싶은가? → 리더, 부사장, 제품 오너 등 → 왜 개발자는 → 낙오자 취급? → 개발자들을 시키는대로 코드를 타이핑하는 열등한 전문직급 취급?

오늘날 회사는 사실상 소프트웨어 회사
...
<details>
  ...
  <div>
✔️ 수정 이유: 폭염주의보 이므로 15분 산책은 오히려 체력을 깎아먹는다고 생각하였습니다. 콧구멍에 바람만 넣고와도 충분히 환기가 될 것이라 생각했습니다.
...
✔️ 유지 및 일부 수정 이유: 명언을 공유함으로써 400명에게 동기부여를 줄 수 있어 좋은 미션이라고 생각하여 유지하였습니다. 단, 명언 채널에 사람이 7명 밖에 없길래 명언 채널을 random 채널로 변경하였습니다.
...
### QUEST 3
✔️ 유지 이유: 좌절하더라도 포기하지않고 화이팅 해서 챌린지를 끝까지 달릴 수 있을 미션 같아서 유지하게 되었습니다.

✔️ 퀘스트: 좌절할 때마다 "나는 내가 정말 좋아" 박수 치기

<img src="https://github.com/user-attachments/assets/7473e9be-5006-4c4a-8858-4cc694dc4ece" width="40%"></img>
...
### QUEST 4
✔️ 유지 이유: 좋아하는 간식을 먹으면서 당 충전도 하고 기분 전환도 해야 더 힘내서 일주일을 잘 보낼 수 있기 때문에 유지하였습니다.
...
### QUEST 5
<details>
  <summary><strike>1,2주차 퀘스트</strike></summary>
  <div>
✔️ 수정 이유: Relax 퀘스트 라기엔 부담이 느껴져 미션의 난이도를 조금 줄이기로 했습니다.
...
✔️ 퀘스트: README.md를 기록할때 설계, 구현 과정에서 자신이 잘 한 부분 1개 이상 작성하기

✔️ 수행 기준:
- 정말 간단하게, `피어 분석에서 말을 잘한것`, `README.md작성시에 적절한 이모티콘을 찾은것`과 같이 사소하지만 자신이 잘한 부분
- 기록방법 : 주 2회 이상 README.md에서 `퀘스트 수행` 항목을 추가해서 작성한다.
...
<details>
  <summary><strike>2주차 퀘스트</strike></summary>
  <div>
✔️ 수정 이유: 다음주는 챌린지가 끝나기 때문에 챌린지 끝나고 휴식 계획을 세우면 좋을것 같다고 생각하여 상황에 맞게 수정하였습니다.
...
✔️ 퀘스트: 챌린지가 끝난 후 휴식 계획 세우기

✔️ 수행 기준:
- 일시: 목요일 저녁 시간 전까지 계획 세우기
- 계획 세운 후 슬랙 랜덤 채널에 공유하고 다른 사람들의 계획도 물어보기

🚨 주의사항
- 잠만 자기 금지
- 단순히 놀거다, 쉴거다 와 같은 내용 금지
- 좋은 예시:
  - 챌린지 할때 집에서만 밥을 먹었기 때문에 가족들과 날을 잡고 소고기 먹으러 갈 계획입니다.
  - 챌린지 동안 헬스장을 못가서 근손실이 왔기 때문에 헬스장을 꾸준히 갈 계획입니다.
